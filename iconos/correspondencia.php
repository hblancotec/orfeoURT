...
//<meta http-equiv="Refresh" content="3;URL=http://www.algunsitio.com/nuevo.html">, 
  ...
  $numerot = ora_numrows($cursor);
   ...
   while($result1=ora_fetch_into($cursor,$row, ORA_FETCHINTO_NULLS|ORA_FETCHINTO_ASSOC))
	 ...
	 $imagen="radicar.gif";
	 echo "<a href='cuerpo.php?carpeta=$numdata&contra=".md5($drd)."&usua=".md5($krd)."&drd=$drd&krd=$krd' target='mainFrame' alt='Seleccione una Carpeta'><img src='iconos/$imagen' border=0 alt='$data' align='absmiddle'> <font size=1><b>Radicación</font></a> <p>"; 
	 ORA_CLOSE($cursor1);
