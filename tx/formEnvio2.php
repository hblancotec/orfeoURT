                        ...
                        /*if ($pasaFiltro == "Si") {
                            ...
                            if (substr($record_id, -1) == "1") {
                                ...
                                if ($rsAnula && !$rsAnula->EOF) {
                                    $codAnula = $rsAnula->fields['SGD_ANU_ID'];
                                } else {
                                    $codAnula = "";
                                }
...
if ($msgError || $mensaje_error_VoBoFax) {
    ...
    ?>
									...
									<table width="500" border=0 align="center" bgcolor="White">
										...
										<tr align="left">
											<td><span class="etextomenu"> </span> <textarea
													name="observa" cols="70" rows="3" class="ecajasfecha"></textarea>
											</td>
										</tr>
										<tr>
