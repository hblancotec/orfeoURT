...
?>
	<tr align="justify" class="<?=$clase?>">
		...
		<td class='listado2' height="12" width="7%" style="text-align: center;" >
			<input type="hidden" name="xx" value="<?php echo $rs->fields['IDCONT'].'-'.$rs->fields['IDPAIS'].'-'.$rs->fields['IDDPTO'].'-'.$rs->fields['IDMPIO'] ?>">
			<input  type="checkbox" id="check_value"  value="selec"  <?php echo "$chequeado NAME=check_value[".$rs->fields['ID']."]" ?> >
		</td>
		<?php
