...
<tr bgcolor="#cccccc" class="textoOpcion"> <?php
...
Valor<br>
De Envio</td>
<td  width='4%' class="grisCCCCCC" align="center"> <?php
if($codusuario==1){
?>
 <?php
 if($devolucion==3)
...
<table border=0 cellspace=2 cellpad=2 WIDTH=98% class='t_bordeGris' align='center'>
  <tr align="center">
   <td> <?php
	...
	$paginas = ($numerot / 20);
	?><span class='etextou'> Paginas</span> <?php
...
// Si es un usuario nuevo pide la nueva contraseña.
	...
	{		
		...
		echo "<table border=0>";
		echo "<tr>";
		echo "<td><center>CONTRASEÑA </td><td><input type='password' name='contradrd' value=''><br></td>";
		echo "</tr>"				 ;
		echo "<tr><td><center>RE-ESCRIBA LA CONTRASEÑA </td><td><input type='password' name='contraver' value=''></td>";
		echo "</tr>";							 
		echo "</table></p></p>";
		echo "";
		echo "";
