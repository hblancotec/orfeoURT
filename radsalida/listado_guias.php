...
switch ($db->driver)
{
	case 'mssqlnative':	$tmp_var= "convert(char(15),a.RADI_NUME_SAL)"; break;
	case 'oracle':	
	case 'oci8':	$tmp_var = "a.RADI_NUME_SAL"; break;
}

$query = "SELECT  
		a.SGD_FENV_CODIGO,
		'', ".
		$db->conn->substr."($tmp_var,5,10) REGISTRO,
		...
		a.SGD_RENV_DEPTO DEPARTAMENTO,
		a.SGD_RENV_DESTINO MUNICIPIO
