<?php
    // Programa que genera el listado de todos los grupos
    // de masiva generados por la dependencia, que no han sido enviados y da la opción de 
...
<?php
   $sqlFecha = $db->conn->SQLDate("Y/m/d","r.SGD_RENV_FECH");
    ...
    $encabezado .= "&dep_sel=$dep_sel&krd=$krd&";
    $encabezado .= "estado_sal=$estado_sal&fechah=$fechah";
    $encabezado .= "&estado_sal_max=$estado_sal_max&ascdesc=$ascdesc&orno=";
    $fechah=date("dmy") . "_". time("h_m_s");
 	$check=1;
            ...
            <TD width='32%'  > 
              <table width="100%" border="0" cellspacing="1" cellpadding="0">
                <tr> 
                  ...
                  <td width="90%" height="20" class='listado2'><?=$_SESSION['usua_nomb'] ?></td>
                </tr>
              </table>
            </td>
              ...
              <table border="0"  cellpad="2" cellspacing="2" WIDTH="100%" class="borde_tab" valign="top" align="center" cellpadding="2">
                <tr bgcolor="titulos5"> 
                  ...
                  <td width='10%' align="left" class='titulos5'> 
                    <input type="button" value='<?=$accion_sal ?>' name=Enviar valign='middle' class='botones_largo' onClick="verificarSeleccion();">
                  </td>
                </tr>
              </table>
            </td>
