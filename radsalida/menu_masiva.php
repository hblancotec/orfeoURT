...
<table width="47%" align="center" border="0" cellpadding="0" cellspacing="5" class="borde_tab">
    ...
    <tr align="center"> 
      <td class="listado2" > 
        <a href='upload2.php?<?=$phpsession ?>&krd=<?=$krd?>&krd=<?=$krd?>&<?php echo "fechah=$fechah"; ?>' class="vinculos"  target='mainFrame'>Generar 
    ...
    <tr align="center"> 
      <td class="listado2" > 
        <a  href='consulta_depmuni.php?<?=$phpsession ?>&krd=<?=$krd?>&krd=<?=$krd?>&<?php echo "fechah=$fechah"; ?>' class="vinculos" target='mainFrame'>Consultar 
          Divisi&oacute;n Pol&iacute;tica Administrativa de Colombia (DIVIPOLA)</a>
      </td>
    </tr>
    <tr align="center"> 
      <td class="listado2" > 
        <a  href='consultaESP.php?<?=$phpsession ?>&krd=<?=$krd?>&krd=<?=$krd?>&<?php echo "fechah=$fechah"; ?>' target='mainFrame' class="vinculos">Consultar 
          ESP </a>
      </td>
    </tr>
