  ...
  <tbody>
    <tr>
      <td>
      	...
      	<a href="form.php?lista=inbox&<?=session_name()."=".session_id() ?>&krd=<?=$krd?>&<?php echo "fechah=$fechah&usr=".md5($dep)."&primera=1&ent=2&depende=$dependencia"; ?>" title="Tiene <?php print " (".inbox_num().")";?> fax(es) nuevo(s) " class="etextomenu" target="formulario">
