...
<html>
<head>
<title>Vinculaci&oacute;n Documento</title>
...
if ($insertar_registro && $numRadi != '') {
    ...
    if ($numRadiBusq == '') {
        $mensaje = "<hr><center><b>
			<span class='alarmas'>No se encontro el radicado, por favor verifique e intente de nuevo</span>
		</center></b></hr>";
    } else {
        ...
        if ($tipVinDocto == 0) {
            ...
            if ($numRadiBusq != '') {
                ...
                if ($ok) {
                    ...
                    if ($radiDeriAnte == '') {
                        $observa = "*Se incluy&oacute; Vinculaci&oacute;n Documento* ($numRadi) Tipo ($detaTipoVin)";
                    } else {
                        $observa = "*Cambio Vinculaci&oacute;n Documento* Anterior($radiDeriAnte) por ($numRadi)";
                    }
...
<table border=0 width=70% align="center" class="borde_tab"
			...
			<tr align="center" class="titulos2">
				<td height="15" class="titulos2">VINCULACI&Oacute;N DOCUMENTOS</td>
			</tr>
		</table>
		<table width="70%" border="0" cellspacing="1" cellpadding="0"
			...
			<tr>
				...
				<td class=listado5><select name='tipVinDocto' class='select'>
		<?php
if ($tipVinDocto == 0) {
    $datosel = " selected ";
} else {
...
?>
			...
			<tr>
				...
				<td class=listado5><input name="numRadi" type="text" size="20"
					class="tex_area" value="<?=$numRadi?>"></td>
			</tr>
		</table>
		<br>
		<table border=0 width=70% align="center" class="borde_tab">
				...
				<td width="33%" height="25" class="listado2" align="center">
					<center>
						<input name="insertar_registro" type=submit
							class="botones_funcion" value="Grabar Cambio">
					</center>
				</td>
				<td width="33%" class="listado2" height="25">
					<center>
						<input name="actualizar" type="button" class="botones_funcion"
							id="envia23" onClick="procModificar();" value=" Busqueda ">
					</center>
				</td>
				<td width="33%" class="listado2" height="25">
					<center>
						<input name="aceptar" type="button" class="botones_funcion"
