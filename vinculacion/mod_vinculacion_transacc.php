...
if ($borrar) {		
    ...
    if  (is_array($recordWhere) && count($recordWhere)>0)
	    ...
	    if($ok){   
			...
			$observa = "*Se Elimin&oacute; la Vinculacion Documento* ($radiDeriAnte) Tipo ($detaTipoVin)";
			...
			$mensaje = "<hr><center><b>
				<span class=info>No se Pudo Eliminar la Vinculacion Documento </span>
			</center></b></hr>";
		}
	}
	else {
