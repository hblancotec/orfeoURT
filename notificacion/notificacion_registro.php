...
//$db->conn->debug=true;
if (!$_SESSION['krd'] or !$_SESSION['dependencia'])   include "$ruta_raiz/rec_session.php";
$verrad =$verradOld;
...
// Programa que actualiza los datos de notificacion para un radicado
...
if ($swInsertado==true){
	//Busca su existe algun tipo de desicion que aplique para el tipo de documento luego de actualizar notificacion
