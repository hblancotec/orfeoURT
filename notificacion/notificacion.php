    ...
    <tr> 
      ...
      <td width="317"><a href=# onClick="changedepesel(21);"><font size="1"> 
         ...
         <script language="javascript">
			var dateAvailable2 = new ctlSpiffyCalendarBox("dateAvailable2", "form_notificacion", "fecha_not","btnDate2","<?php
			if (strlen($tFechNot))
				echo($tFechNot);
    ...
    <tr> 
      ...
      <td width="316"><a href=# onClick="changedepesel(21);"><font size="1"> 
        ...
        <script language="javascript">
			...
			document.form_notificacion.fecha_fij.value="<?php
			if (strlen($tFechFija))
				echo($tFechFija); 
    ...
    <tr> 
      ...
      <td width="316"><a href=# onClick="changedepesel(21);"><font size="1"> 
        <script language="javascript">
			...
			document.form_notificacion.fecha_desfij.value="<?php
