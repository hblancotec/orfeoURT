...
class radicacionServer extends HTML_AJAX_Server {
	...
	function initRadicacion() {
		...
		$this->registerClass(new radicacionAjax($this->db,$this->ruta_raiz),'radicacionAjax',array('newRadicadoAjax','insertDireccionAjax','insertVarsDireccionAjax','enviarCorreo'));
	}
