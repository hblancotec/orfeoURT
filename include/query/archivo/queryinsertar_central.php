<?php
	...
	sgd_archivo_unidocu,sgd_archivo_inder,sgd_archivo_mata) values ($sec,'$rad',$orden,'$fechaIni','$fechaInif',$ano,'$depe','$demq','$demtq',$docu,$codiSRD,
	$codiSBRD,$proc,$folios,'$zon',$carro,'$cara',$estante,$entre,$caja,'$unidocu',$inder,$mata)";
	...
	sgd_archivo_mata=$mata where sgd_archivo_rad like '$rad'";
