...
//codigo estupido 
	$whereProceso = (isset($_REQUEST['codProceso']) && $_REQUEST['codProceso'] != '') ? " AND sExp.SGD_PEXP_CODIGO = ".$_REQUEST['codProceso'] : '';
	$whereDependencia = ($dependencia_busq != 99999) ? "WHERE sExp.DEPE_CODI = 1 $whereDependencia" : '';
	...
	$queryEDetalle = "SELECT b.USUA_NOMB USUARIO
		...
		WHERE 
			...
			$whereEstadoProc
			$whereAnoExp";
			// AND sExp.depe_codi=b.depe_codi	and sExp.usua_doc_responsable=$usuaDocProc
