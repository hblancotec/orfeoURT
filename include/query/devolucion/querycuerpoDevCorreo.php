<?php 
    ...
    switch($db->driver) {
        case 'mssqlnative':
            $sqlConcat = $db->conn->Concat("convert(char(15),a.radi_nume_sal,0)","'-'","convert(char(6),a.sgd_renv_codigo,0)");
                $isql = 'select ' . 4 . ' AS CHU_ESTADO,
                            ...
                            from sgd_renv_regenvio a left outer join SGD_FENV_FRMENVIO b 
                            ...
                            where
                                ...
                                $sql_masiva . '
                                and	c.radi_nume_radi= a.radi_nume_sal AND
                                c.radi_depe_actu = USD.depe_codi AND
                                c.radi_usua_actu = d.usua_codi AND
                                d.USUA_DOC = USD.USUA_DOC
