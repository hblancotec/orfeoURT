...
class TipoDocumental
{
 ...
 // end of member function cconsultaTipoTRD
     ...
     * @param
     *            int usuadoc Documento de identificacion del usuario que solicita la transaccion
     * @return void
     * @access public
     */
    function insertarTRD($codiTRDS, $codiTRD, $noRadicado, $coddepe, $codusuario)
    {
        ...
        $sql = "SELECT USUA.USUA_DOC,
				...
				WHERE USD.DEPE_CODI = $coddepe AND
                        USD.USUA_DOC = USUA.USUA_DOC AND
                        USD.USUA_LOGIN = USUA.USUA_LOGIN AND
                        USUA.USUA_CODI = $codusuario";
 ...
 // end of member function insertarTRD
    ...
    { // Arreglo que almacena los nombres de columna
      ...
      // Busca el Documento del usuario
        ...
        $sql = "SELECT USUA.USUA_DOC,
                        USUA.USUA_LOGIN
				FROM USUARIO, USD.SGD_USD_USUADEPE USD
				WHERE USD.DEPE_CODI=$coddepe AND
 ...
 // end of member function eliminarTRD
    ...
    function calcFechVenc($fldTermino, $fldFechInic)
    {
        ...
        $radi_nume_deri = " convert(varchar(15), r.radi_nume_deri) ";
        ...
        $anex_radi_nume = " convert(varchar(15), r.anex_radi_nume) ";
    ...
    { // El siguiente include presenta problemas con la funcion round de adodb
      // include_once ("../include/query/busqueda/busquedaPiloto1.php");
        unset($db);
        // tdoc_codi = 0 and
        foreach ($radicados as $noRadicado) {
            $sql = "SELECT  TDOC_CODI
							FROM radicado 
						WHERE radi_nume_radi = " . $noRadicado;
            ...
            if (! empty($fldRADI_NUME_RADI)) {
                ...
                $uSQL = "UPDATE RADICADO SET FECH_VCMTO =  " . $db3->conn->SQLDate('Y/m/d H:i:s', $fecVenEval) . " WHERE radi_nume_radi = $fldRADI_NUME_RADI ";
                $db3->query($uSQL);
            }
