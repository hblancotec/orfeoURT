...
class Sancionados{
   ...
   */
	...
	*/
	...
	/** 
	* Carga los atributos de la clase con la informacion de sancionados exitente para un numero de radicado
...
{	switch ($this->cursor->driver)
	{
	case 'mssqlnative':	$tmp_conv ="CONVERT(varchar(21), CAST(SGD_SAN_VALOR AS money), 1)";
					break;
	case 'oracle':
	case 'oci8':	$tmp_conv ="to_char(SGD_SAN_VALOR, '99,999,999,999,999.99')";
					break;
	default:		break;
	}
	
	$sql = "select $tmp_conv S_VALOR_FORMATO, s.*  from sgd_san_sancionados s where s.sgd_san_ref  ='$radi'";
	...
	/** 
     * Busca los campos de combinacion que ha de incluirse teniendo en cuenta la informacion de sanciondos  y los adiciona a los arreglos que ha de procesar luego la funcion de  combinacion de correspondencia. Debe invocarse antes sancionadosRad()
   	 * @param $campos	array	Etiquetas a combinar
	 * @param $datos	array	Valores de las etiquetas a combinar
	*/
