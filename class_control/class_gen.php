...
class CLASS_GEN {
	...
	/**
	 * Traduce fecha iso a formato string asi "29-11-2018" pasa a "29 NOV. 2018" 
	 * @param string $fecha Formato mm/dd/yyy
	 */
	function traduceResolucion($fecha){
		$d=strtotime($fecha);
		switch (date('n', $d)) {
			case 1: { $m = 'ENE'; } break;
			case 2: { $m = 'FEB'; } break;
		...
		return strtoupper(date('d', $d) . " ". $m . ". " .date('Y', $d));
	}
}
?>
