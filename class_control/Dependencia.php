<?php
    ...
    require_once(ORFEOPATH . "class_control/Municipio.php");
    /**
     * Esp es la clase encargada de gestionar las operaciones y los datos bsicos referentes a una Dependencia
     * @author	Sixto Angel Pinzn
     * @version	1.0
     */
      ...
      */
        function dependenciaArr($codigo){
            ...
            if  (!$rs->EOF) {
                ...
                $retorno['dep_estado']   = $rs->fields['DEPENDENCIA_ESTADO'];
    ...
    */		
    ...
    /** 
    * Retorna el valor string correspondiente al codigo de la dependencia que permitiria generar la secuencia de radicacion de acuerdo al tipo de radicaci n sea esta (-1,-2,-3,-4,-5) , debe invocarse antes Dependencia_codigo() 
    *  @param	$codDepe	integer es el c digo de la Dependencia
