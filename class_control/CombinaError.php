...
class CombinaError extends Error
{
     ...
     *
     * @param integer $code
     *            Es el codigo del error
     * @return void
     */
    function tipoError($code = 0)
    {
        if ($code == NO_DEFINIDO) {
            $error = "<BR> No se pudo completar la transaccion debido a posibles problemas como: " . "<BR> " . "<BR> - Su archivo de combinaci&oacute;n no corresponde a la plantilla establecida. " . "<BR> - Problemas con el servidor de combinacion de documentos. " . "<BR> - Problemas con la red. " . "<BR> - Por favor verifique e intente mas tarde ";
        }
