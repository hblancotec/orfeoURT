...
?>
     <table width="1500" class="FormTABLE">
      ...
      <tr>
       ...
       <td width="55" class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormRADICADO_Sorting=2&FormRADICADO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Fecha Radicación</font></a></td>
...
//  echo "$sSQL";
/*
$db->conn->Execute($sSQLCount1);
$next_record = $db->next_record();
$fldTotal1 = $db->f("TOTAL"); 

$db->conn->Execute($sSQLCount2);
$next_record = $db->next_record();
