...
<?php Search_show() ?>
   ...
   <td valign="top"><font class="FieldCaptionFONT">
	 ...
	 <a href="../busqueda/busquedaExp.php?<?=$phpsession ?>&krd=<?=$krd?>&<?php ECHO "&fechah=$fechah&primera=1&ent=2"; ?>">Busqueda Expediente</a>
   </font></td>
  </tr>
 </table> 
  <table>
...
?>
  ...
  <tr>
   <td valign="top">
<?php if($flds_empresaESP=="ESP") EmpresaESP_show($nivelus); ?>

   </td>
  </tr>
  <tr>
   <td valign="top">
<?php if($flds_oEmpresa=="OEM") OtrasEmpresas_show($nivelus); ?>

   </td>
  </tr>
  <tr>
   <td valign="top">
<?php if($flds_FUNCIONARIO=="FUN") FUNCIONARIO_show($nivelus); ?>
   </td>
  </tr>
