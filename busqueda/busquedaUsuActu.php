...
<meta name="GENERATOR"
	content="YesSoftware CodeCharge v.2.0.5 build 11/30/2001">
...
<script>
  ...
  function busqueda() {
		...
		if (divGri != null) {
    		...
    		var palabra = document.getElementById('s_RADI_NOMB').value;
			...
			<tr>
				<td valign="top">
					...
					<form method="post" action="<?=$encabezadol?>" name="Search">
						<input type="hidden" name="FormName" value="Search"><input
							type="hidden" name="FormAction" value="search">
						<table border=0 cellpadding=0 cellspacing=2 class='borde_tab'>
							<tbody>
								<tr>
									<td class="titulos4" colspan="13"><a name="Search">Busqueda por
											Usuario</a></td>
								</tr>

								<tr>
									<td class="titulos5">Radicado</td>
									<td class="listado5"><input class="tex_area" type="text"
										name="n_nume_radi" id="n_nume_radi" maxlength=""
										value="<?=$n_nume_radi?>" size=""></td>
								</tr>
								<tr>
									<td class="titulos5"><INPUT type="radio" NAME="s_solo_nomb" value="All" CHECKED
										<?php if($s_solo_nomb=="All"){ echo ("CHECKED");} ?>>Todas las
										palabras (y)<br> <INPUT type="radio" NAME="s_solo_nomb"
										value="Any"
										<?php if($s_solo_nomb=="Any"){echo ("CHECKED");} ?>>Cualquier
										Palabra (o)<br></td>
									<td class="listado5"><input class="tex_area" type="text"
										id="s_RADI_NOMB" name="s_RADI_NOMB" maxlength="70" value="<?=$s_RADI_NOMB?>"
										size="70"></td>
								</tr>
								<tr>
...
?>
								...
								<tr>
									...
									<input class="botones" value="Busqueda" type="button" onclick="busqueda();"></td>
								</tr>
							</tbody>
						</table>
					</form>
				...
				<td valign="top"><a class="vinculos"
					href="../busqueda/busquedaPiloto.php?<?=$phpsession ?>&krd=<?=$krd?>&<?php echo "&fechah=$fechah&primera=1&ent=2"; ?>">Busqueda
						clasica</a><br> <a class="vinculos"
					href="../busqueda/busquedaHist.php?<?=$phpsession ?>&krd=<?=$krd?>&<?php echo "&fechah=$fechah&primera=1&ent=2"; ?>">Busqueda
						Historicos</a><br> <a class="vinculos"
					href="../busqueda/busquedaExp.php?<?=$phpsession ?>&krd=<?=$krd?>&<?php echo "&fechah=$fechah&primera=1&ent=2"; ?>">Busqueda
						Expediente</a></td>
			</tr>
		</tbody>
	</table>
                		...
                		<table id="grid" class="display nowrap stripe row-border order-column">
                    		<thead>
                        		<tr>
                        			...
                        			<th class=titulos3>Usuario Actual</th>
