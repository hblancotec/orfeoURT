...
<?php Search_show() ?>
   ...
   <td valign="top"><font class="FieldCaptionFONT"><a href="busquedaHist.php?<?=session_name()."=".session_id()."&fechah=$fechah&krd=$krd" ?>">Búsqueda por histórico</a><br><a href="busquedaUsuActu.php?<?=session_name()."=".session_id()."&fechah=$fechah&krd=$krd" ?>">Reporte por Usuarios</a></font></td>
  </tr>
 </table>
 <table>
  <tr>
   <td valign="top">
<?php if($flds_ciudadano=="CIU" || 
		( !strlen($flds_ciudadano) && !strlen($flds_empresaESP) && !strlen($flds_oEmpresa) ) )Ciudadano_show(); ?>
   </td>
  </tr>
  <tr>
   <td valign="top">
<?php if($flds_empresaESP=="ESP") EmpresaESP_show(); ?>
    
   </td>
  </tr>
  <tr>
   <td valign="top">
<?php if($flds_oEmpresa=="OEM") OtrasEmpresas_show(); ?>
...
<tr>
  ...
  <?php if($flds_solo_nomb=="Any"){echo ("CHECKED");} ?>>Cualquier Palabra (o)<br>
  </font></td>
...
?>
     <table width="2000" class="FormTABLE">
      ...
      <tr>
       ...
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormCIUDADANO_Sorting=2&FormCIUDADANO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Fecha Radicación</font></a></td>
       ...
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormCIUDADANO_Sorting=7&FormCIUDADANO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Teléfono contacto</font></a></td>
...
?>
	  ...
	  <?php if (strlen($fldRADI_PATH)){ $iii = $iii +1;?>  <a href='../bodega<?=$fldRADI_PATH?>' target='Imagen<?=$iii?>'><?}?>
...
?>
     <table width="2000" class="FormTABLE">
      ...
      <tr>
       ...
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormEMPRESAESP_Sorting=2&FormEMPRESAESP_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Fecha Radicación</font></a></td>
       ...
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormEMPRESAESP_Sorting=7&FormEMPRESAESP_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Teléfono contacto</font></a></td>
...
?>
     <table width="2000" class="FormTABLE">
      ...
      <tr>
       ...
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormOEMPRESAS_Sorting=2&FormOEMPRESAS_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Fecha Radicación</font></a></td>
       ...
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormOEMPRESAS_Sorting=7&FormOEMPRESAS_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Teléfono contacto</font></a></td>
