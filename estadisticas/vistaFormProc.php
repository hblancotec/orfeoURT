...
<table width="100%"  border="0" cellpadding="0" cellspacing="5" class="borde_tab">
  <tr> 
    <td colspan="2" class="titulos4"><A href='vistaFormConsulta.php?<?=session_name()."=".trim(session_id())."&krd=$krd&fechah=$fechah"?>' style="color: #FFFFCC;">Estad�sticas </A> - <center>PROCESOS </center> </td>
  </tr>
  <tr>
...
<tr id="cUsuario">
  ...
  <tr id="cPFecha">
	...
	<?php
  		...
  		$rs1 = $db->conn->Execute($sqlprocesos);
		$valor = "";
