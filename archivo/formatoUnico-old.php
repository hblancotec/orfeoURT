...
$encabezadol = $_SERVER['PHP_SELF']."?".session_name()."=".session_id()."&num_exp=$num_exp&krd=$krd";
$usua_perm_archi=1;
...
$rs=$db->conn->Execute($isql);
	...
	?><select id='<?=$id; ?>'  onchange='CAJAS("<?php echo $next;?>");'><option value='not'>-- Selecione -- </option><?php echo $option; ?></select><?php 	
