...
include_once("$ruta_raiz/include/db/ConnectionHandler.php");
	...
	$encabezadol = $_SERVER['PHP_SELF']."?".session_name()."=".session_id()."krd=$krd&Tipo=$Tipo";
...
<td class=leidos2 ><b><span class=leidos2><?php echo $depe;?></b></td>
</tr>
<tr><TD class=titulos5 >OFICINA PRODUCTORA </td>
<td class=leidos2 ><b><span class=leidos2><?php echo $depe_nom;?></b></td>
</tr>
...
<?php include_once("$ruta_raiz/config.php"); ?>
...
<td class=leidos2 ><b><span class=leidos2><?php echo $expnum;?></b>
<b><span class=leidos2><?php echo $titulo;?></b></td>
<td class=leidos2 ><b><span class=leidos2>&nbsp;&nbsp;<?php if($unidad==1)echo "X";?></b>
 <b><span class=leidos2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php if($unidad==2)echo "   X";?></b>
 <b><span class=leidos2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php if($unidad==3)echo "       X";?></b>
 <b><span class=leidos2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php if($unidad==4)echo "           X";?></b></td>
<td class=leidos2  width="80"><?php echo $fech;?>&nbsp;<?php echo $fechfin;?></td>
<td class=leidos2 align="center" ><b><span class=leidos2><?php echo $radicados;?></b></td>
<td class=leidos2 align="center"><b><span class=leidos2><?php echo $folios;?></b></td>
<td class=leidos2 align="center"><b><span class=leidos2><?php echo $nundocu;?></b></td>
<td class=leidos2 align="center"><b><span class=leidos2><?php echo $nundocub;?></b></td>
<td class=leidos2 align="center"><b><span class=leidos2><?php echo $caja;?></b></td>
<td class=leidos2 align="center"><b><span class=leidos2><?php echo $cajab;?></b></td>
<td class=leidos2 align="center"><b><span class=leidos2><?php echo $srd_desc;?></b></td>
<td class=leidos2 align="center"><b><span class=leidos2><?php echo $srd;?></b></td>
<td class=leidos2 align="center"><b><span class=leidos2><?php echo $sbrd_desc;?></b></td>
<td class=leidos2 align="center"><b><span class=leidos2><?php echo $sbrd;?></b></td>
<td class=leidos2 ><b><span class=leidos2>&nbsp;&nbsp;<?php if($rete==1)echo "X";?></b>
 <b><span class=leidos2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?if($rete==2)echo "    X";?></b></td>
<td class=leidos2 align="center"><b><span class=leidos2><?php echo $disfinal;?></b></td>
<td class=leidos2 align="center"><b><span class=leidos2><?php echo $ubicacion;?></b></td>
<td class=leidos2 align="center" ><b><span class=leidos2><?php echo $observa;?></b></td>
