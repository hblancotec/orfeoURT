...
if($_GET['action']=='muni'){
    ?><select  class='select' id="mun" name="codMuni2" onchange="edificio()"><option>-- Seleccione --</option><?php
	 echo       municipio($db,$_GET['depto']);
		  	?></select><?php
}

if($_GET['action']=='edificio'){
    ?><select class='select' id="edif" name="exp_edificio2" onchange="piso('piso')"><option>-- Seleccione --</option><?php
