<?php
	...
	$sql = "select d.iddcf, d.usua_login, d.usua_doc, d.estado, d.tiposol 
	...
	$username = mb_convert_encoding($_SESSION["usua_nomb"], 'UTF-8', 'ISO-8859-1');
	$no_permitidas= array ("á","é","í","ó","ú","Á","É","Í","Ó","Ú","ñ","À","Ã","Ì","Ò","Ù","Ã™","Ã ","Ã¨","Ã¬","Ã²","Ã¹","ç","Ç","Ã¢","ê","Ã®","Ã´","Ã»","Ã‚","ÃŠ","ÃŽ","Ã”","Ã›","ü","Ã¶","Ã–","Ã¯","Ã¤","«","Ò","Ã","Ã„","Ã‹");
	$permitidas= array ("a","e","i","o","u","A","E","I","O","U","n","N","A","E","I","O","U","a","e","i","o","u","c","C","a","e","i","o","u","A","E","I","O","U","u","o","O","i","a","e","U","I","A","E");
	$username = str_replace($no_permitidas, $permitidas, $username);
	
	$file = $_REQUEST['file'];
	$signerId = $_SESSION["identificacion"];
	$signerCommonName = $username;
	...
	$backgroundSignImage = isset($_REQUEST['backgroundSignImage']) ? $_REQUEST["backgroundSignImage"] : " ";
	$leftSignImage = isset($_REQUEST['leftSignImage']) ? $_REQUEST["leftSignImage"] : " ";
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script type="text/javascript">
			...
			var backgroundSignImage = '<?=$backgroundSignImage?>';
			var leftSignImage = '<?=$leftSignImage?>';
			...
			<div class="row justify-content-md-center">
				<div class="card text-center" style="width: 30rem;">
					...
					<div class="card-body">
						...
						<a id="retrySign" href="javascript:hashProcess (globalTimeStamp, globalFile, globalUser, globalIdentification, globalTimestampFlag, globalVisible, globalLowerLeftX, globalLowerLeftY, globalUpperRightX, globalUpperRightY, globalQrCodeSize, globalQrCodeVisibility, globalPage, globalPlaceholder, qrPage, absoluteX, absoluteY, absoluteSize, renderingMode, description, qrBackgroundImageFlag, qrBackgroundImageOffset, backgroundSignImage, leftSignImage);" class="btn btn-primary" style="display: none"><i class="fa fa-pencil fa-fw"></i>  <i class="fa fa-user fa-fw"></i> Reintentar firma digital</a>
                    ...
                    <div class="card-body">
                        ...
                        <?php
                            ...
                            foreach (explode('|', $file) as $currentToken)
                            {
                                ...
                                //$currentToken = str_replace("bodega7", "bodega", $currentToken);
                                //$currentToken = str_replace("//vorfeobod", "", $currentToken);
						...
						<div class="row align-items-center" id="rowFile<?=$i?>">
							...
							<div class="col-md-3" id="fail<?=$i?>" style="display: none">
								<a style="color:red;" data-toggle="tooltip" data-placement="right" class="btn btn-outline-danger btn-sm" href="javascript:hashProcess (globalTimeStamp, files[<?=$i-1?>], globalUser, globalIdentification, globalTimestampFlag, globalVisible, globalLowerLeftX, globalLowerLeftY, globalUpperRightX, globalUpperRightY, globalQrCodeSize, globalQrCodeVisibility, globalPage, globalPlaceholder,qrPage, absoluteX, absoluteY, absoluteSize, renderingMode, description, qrBackgroundImageFlag, qrBackgroundImageOffset, backgroundSignImage, leftSignImage, <?=$i?>);">
