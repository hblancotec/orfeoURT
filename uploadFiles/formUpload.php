...
<table border=0 width=100% cellpadding="0" cellspacing="0">
	...
	<td width=100%>
		...
		<table width="98%" border="0" cellpadding="0" cellspacing="5" class="borde_tab">
			...
			<td class="titulos4">Asociaci&oacute;n de Imagen a Radicado<BR></td>
			...
			<tr>
				<td colspan=5 align="center">
					...
					<span class="leidos">Seleccione un Archivo (pdf/tif). Tama&ntilde;o Max. <?=ini_get('upload_max_filesize')?><input type="file" name="upload" size="50" class=tex_area></span>
...
<?php
   ...
   include_once "../include/query/uploadFile/queryUploadFileRad.php";
	...
	$pager = new ADODB_Paginacion($db,$query2,'adodb', true,$orderNo,$orderTipo);
