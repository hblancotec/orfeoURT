...
class Bootstrap {
    ...
    private $_viewPath = 'views/'; // Always include trailing slash
     ...
     */
    public function _loadExistingController()
    {
        ...
        if (file_exists($file)) {
            ...
            $this->_controller->loadModel($this->_url[0], $this->_modelPath, $this->_viewPath);
        } else {
            $this->_error();
            return false;
        }
