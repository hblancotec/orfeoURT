		...
		*/
		...
		function modificarTrdMass(){
			var selectTipoDoc	= YAHOO.util.Dom.get("selectTipoDoc").value,
				...
				element7		= Dom.get('justificacion'),
				...
				justificacion	= (Dom.get("justificacion")).value,
				...
				texto4 			= document.createTextNode(justificacion),
									
				mensaje1		= 'Por favor complete todos los campos';
			
			element4.appendChild(texto1);
			element3.appendChild(texto2);
			element2.appendChild(texto3);
			element7.appendChild(texto4);
			
			if(selectTipoDoc != 0 && justificacion != 0){
