 ...
 function jhrtf($archivo_inicial,$archivo_final)
  ...
  function combinar_csv() 
   { 
	   ...
	   {   $i=0;
           //$campos = array ("*DESTINATARIO*"            ,"*DIRECCION*"     ,"*DEPARTAMENTO*"  ,"MUNICIPIO","*F_RAD_E*"            ,"*NOM_R*"        ,"*DIR_R*"         ,"*DEPTO_R*"     ,"*MPIO_R*"        ,"*TEL_R*"      ,"*MAIL_R*","*DOC_R*"          ,"*NOM_P*"       ,"*DIR_P*"      ,"*DEPTO_P*"         ,"*MPIO_P*"        ,"*TEL_P*"      ,"*MAIL_P*","*DOC_P*"          ,"*NOM_E*"     ,"*DIR_E*"       ,"*MPIO_E*"     ,"*DEPTO_E*"        ,"*TEL_E*"       ,"*MAIL_E*","*NIT_E*"          ,"*F_RAD_S*"       ,"*RAD_E*","*SECTOR*"       ,"*NRO_PAGS*"   ,"*DESC_ANEXOS*","*F_HOY_CORTO*"    ,"*F_HOY*");
		   //$datos = array  ("jhRAD_S AKSDFJASDHF "      ,"jhRAD_E_PADRE"   ,"HUILA"           ,"PITALITO$ii" ,"y23523454"            ,"*NOM_R*"        ,"*DIR_R*"         ,"*DEPTO_R*"     ,"*MPIO_R*"        ,"*TEL_R*"      ,"*MAIL_R*","*DOC_R*"          ,"*NOM_P*"       ,"*DIR_P*"      ,"*DEPTO_P*"         ,"*MPIO_P*"        ,"*TEL_P*"      ,"*MAIL_P*","*DOC_P*"          ,"*NOM_E*"     ,"*DIR_E*"       ,"*MPIO_E*"     ,"*DEPTO_E*"        ,"*TEL_E*"       ,"*MAIL_E*","*NIT_E*"          ,"*F_RAD_S*"       ,"*RAD_E*","*SECTOR*"       ,"*NRO_PAGS*"   ,"*DESC_ANEXOS*","*F_HOY_CORTO*"    ,"*F_HOY*");
		   $texto_tmp = $this->texto;	
		   foreach($this->encabezado[0] as $campos_d) {
		   	 // echo ("****  ".$campos_d . "  " . $this->datos[$ii][$i]."  ***"); 
		      $texto_tmp = str_replace($campos_d,$this->datos[$ii][$i],$texto_tmp);
			  $i++;
		   }
