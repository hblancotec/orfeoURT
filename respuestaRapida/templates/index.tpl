...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <form id="form1" name="form1" method="post" enctype="multipart/form-data" 
                action='../respuestaRapida/genRespuesta.php?<!--{$sid}-->' onsubmit="return valFo(this)">
            ...
            <table border="0" width="100%" align="center" cellspacing="0" cellpadding="0">
                ...
                <tr align="center" class="titulos2">
                    <td height="15" colspan="4" class="titulos4">RESPUESTA RAPIDA PARA EL RADICADO <!--{$radPadre}--> </td>
                </tr>
                        ...
                        <table border="0" width="100%" align="center" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="50%">
                                    ...
                                    name="destinatario" value='<!--{$destinatario}-->' maxlength="300">
                                </td>
                            </tr>
                            <tr>
                               <td width="20px" class="titulos">CC:</td>
                               <td>
                                 <input  class="select_resp" type=text name="concopia" value='<!--{$concopia}-->' maxlength="400">
                               </td>
                               <td width="20px" class="titulos">CCO</td>
                               <td>
                                 <input class="select_resp" type=text name="concopiaOculta" value='<!--{$concopiaOculta}-->' maxlength="400">
                               </td>
                            </tr>
							<tr>
