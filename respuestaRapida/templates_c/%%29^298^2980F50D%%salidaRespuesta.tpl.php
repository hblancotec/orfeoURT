<?php /* Smarty version 2.6.20, created on 2013-12-23 17:47:16
...
&tsub=0&codserie=0" 
        width='100%' height='320px' style='border: 0px'></iframe>
        <?php endif; ?>
        <center><h1><input type="button" value="Salir" class="botones" onclick="window.close();"></h1></center>
    </body>
</html>