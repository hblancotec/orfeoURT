...
if ($depe)
	...
	$whereDep = " AND DEPE_CODI = 410";

if ($seri)
	$whereSrd = " AND SGD_SRD_CODIGO =".$seri;
else 
	$whereSrd = " AND SGD_SRD_CODIGO = 2848";
...
$sql = "SELECT	SGD_SEXP_PAREXP1,
		...
		WHERE	SGD_SEXP_PAREXP1 COLLATE SQL_Latin1_General_Cp1_CI_AI LIKE '%".$datoBuscar."%' AND
...
//imprimo en la pagina la conversion a JSON del array anterior
