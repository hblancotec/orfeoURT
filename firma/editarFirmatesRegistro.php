...
<body>
<?php
if (!$_SESSION['dependencia'] || strlen(trim($_SESSION['usua_doc']))==0  )   
...
while ($i < $num) { 
	...
	$datosFirma = $objFirma->firmaIdDetalle($record_id);
	...
	if (!$db->delete("SGD_CICLOFIRMADODETALLE",array('iddcf' => $record_id))) {
