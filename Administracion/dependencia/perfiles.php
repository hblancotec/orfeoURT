...
function validacion()
{
	...
	{
		alert("No se ha diligenciado el Código de la Dependencia, o a diligenciado un valor no númerico. Por favor digítelo.");
	...
	{
		alert("No se ha diligenciado el Nombre de la Dependencia por favor digítelo.");
...
?>
  <tr>
    <td colspan="2"><div align="center"><strong>Edición de Dependencias</strong></div></td>
  </tr>
  <?php
	}
else
...
?>
  <tr>
    <td colspan="2"><div align="center"><strong>Creación de Dependencias</strong> </div></td>
  </tr>
  <?php
	}
?>
