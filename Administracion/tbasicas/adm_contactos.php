...
{	$db->conn->SetFetchMode(ADODB_FETCH_ASSOC);
	...
	{	case '0':
			...
			$rs_idtipo = $db->conn->CacheExecute(60, $sql);
...
<table width="75%" border="1" align="center" class=t_bordeGris>
	<tr class=timparr>
		...
		<td width="72%" class="listado2" height="1">
			...
			<option value='' <?php (isset($_POST['idtipo'])) ? print "" : print "selected"; ?>>&lt;&lt; Seleccione &gt;&gt;</option>
			<option value='0' <?php ($_POST['idtipo'] == '0')? print "selected" : print ""; ?>>Entidad</option>
		    <option value='1' <?php ($_POST['idtipo'] == '1')? print "selected" : print ""; ?>>Otras Empresas</option>
			</select>
		</td>
	</tr>
	<tr class=timparr>
...
{	echo '<tr bordercolor="#FFFFFF">
	...
	{	case 1:	echo "Informaci&oacute;n actualizada!!";break;													//ACUTALIZACION REALIZADA
		case 2:	echo "Contacto creado satisfactoriamente!!";break;										//INSERCION REALIZADA
		...
		case 5:	echo "No se puede eliminar Contacto, se encuentra ligado a historial.";break;			//IMPOSIBILIDAD DE ELIMINAR PAIS, EST� LIGADO CON DIRECCIONES
	}
	echo '</td></tr>';
}
?>
