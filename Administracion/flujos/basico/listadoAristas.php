...
<tr align='middle'>
 <td width="10%" class='listado2' ><font size=1>
 	<?php echo $etapaInicialList ?>
 </td>
 <td width="10%" class='listado2' ><font size=1>
 	<?php echo $etapaFinalList ?>
 </td>
 <td width="80%" class='listado2' ><font size=1>
 	<?php echo $descripcionAristaList ?>
 </td>
 <td width="10%" class='listado2' ><font size=1>
 	<?php echo $diasMinimoList ?>
 </td>
 <td width="10%" class='listado2' ><font size=1>
 	<?php echo $diasMaximoList ?>
 </td>
 <td width="80%" class='listado2' ><font size=1>
 	<?php echo $tradList ?>
 </td>
 <td width="10%" class='listado2' ><font size=1>
 	<?php echo ( $automaticoList == 1 ? "si" : "no" ) ?>
 </td>
 <td width="10%" class='listado2' ><font size=1>
 	<?php echo ( $tipificacionList == 1 ? "si" : "no" )?>
 </td>
 <td width="80%" class='listado2' ><font size=1>
 	<?php echo $serieList ?>
 </td>
 <td width="10%" class='listado2' ><font size=1>
 	<?php echo $subserieList ?>
 </td>
 <td width="10%" class='listado2' ><font size=1>
 	<?php echo $tprList ?>
 </td>
