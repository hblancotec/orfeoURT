...
class Arista{
	 ...
	 * @return Arista
	 */    
	function __construct(  $etapaInicial, $etapaFinal, $descripcionArista, $diasMinimo, $diasMaximo, $trad,$codserie,$tsub, $tipo, $procesoSelected, $automatico, $tipificacion ) {
        $this->__construct = $etapaInicial;
