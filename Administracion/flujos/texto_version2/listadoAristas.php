...
$rs=$db->conn->Execute($sqlListadoAristas);
...
<tr align='middle'>
 <td width="10%" class='listado2' ><font size=1>
 	<center><?php echo $etapaInicialList ?></center>
 </td>
 <td width="10%" class='listado2' ><font size=1>
 <center>	<?php echo $etapaFinalList ?></center>
 </td>
 <td width="80%" class='listado2' ><font size=1>
 <center>	<?php echo $descripcionAristaList ?></center>
 </td>
 <td width="10%" class='listado2' ><font size=1>
 	<center><?php echo $diasMinimoList ?></center>
 </td>
 <td width="10%" class='listado2' ><font size=1>
 <center>	<?php echo $diasMaximoList ?></center>
 </td>
 <td width="80%" class='listado2' ><font size=1>
 	<center><?php echo $tradList ?></center>
 </td>
 <td width="10%" class='listado2' ><font size=1>
 	<center><?php echo ( $automaticoList == 1 ? "si" : "no" ) ?></center>
 </td>
 <td width="10%" class='listado2' ><font size=1>
 	<center><?php echo ( $tipificacionList == 1 ? "si" : "no" )?>
 </td>
 <td width="80%" class='listado2' ><font size=1>
 	<center><?php echo $serieList ?></center>
 </td>
 <td width="10%" class='listado2' ><font size=1>
 	<center><?php echo $subserieList ?></center>
 </td>
 <td width="10%" class='listado2' ><font size=1>
 	<center><?php echo $tprList ?></center>
 </td>
