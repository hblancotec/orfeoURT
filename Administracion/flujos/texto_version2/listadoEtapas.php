...
<tr align='middle'><td height="25" class="titulos4" colspan="10">ETAPAS DEL PROCESO:  '<?php echo $nombreProceso; ?>'  </td></tr>
</table>
...
<tr>
 <td width="10%" class='listado2' ><font size=1>
 	<center><?php echo $ordenEtapa ?></center>
 </td>
 <td width="10%" class='listado2' ><font size=1>
 	<center><?php echo $codigoEtapa ?></center>
 </td>
 <td width="60%" class='listado2' ><font size=3>
 	<center><?php echo $nombreEtapa ?></center>
 	...
 	<table WIDTH="90%" align="center" border="0" cellpadding="0" cellspacing="5" class="borde_tab" >
		...
		<?php
			...
			$rsAristasEntrada=$db->conn->Execute( $sqlListadoAristasEntrada );
			...
			while( !$rsAristasEntrada->EOF )
			{
				...
				$rsNombreEtapa=$db->conn->Execute( $sqlNombreEtapa );
				$nombreEtapaEntrada = $rsNombreEtapa->fields['SGD_FEXP_DESCRIP'];
		?>
				<tr>
					 <td width="10%" class='listado2' ><font size=1>
					 	<img src="../../../imagenes/FlechasEntrada2b.gif">  <?php echo $codigoArista ?> - <?php echo $nombreArista ?> <font color="Green"> llega desde la etapa <?php echo "'" . $nombreEtapaEntrada . "'" ?> </font>
					 </td>
					 <td width="10%" class='listado2' ><font size=1>
					 	<center>
		...
		$sqlListadoAristasSalida .= " and sgd_fexp_codigoini = $codigoEtapa order by  sgd_fars_codigo";
			...
			$rsAristasSalida=$db->conn->Execute( $sqlListadoAristasSalida );
		...
		?>
				<tr>
					 <td width="10%" class='listado2' ><font size=1>
					 	<img src="../../../imagenes/FlechasSalida.gif"><?php echo $codigoArista ?> - <?php echo $nombreArista ?> <font color="Green"> sale a la etapa <?php echo "'" . $nombreEtapaSalida . "'" ?> </font>
					 </td>
					 <td width="10%" class='listado2' ><font size=1>
					 	<center>
 							<input type="image" name="Button" value="Modificar" src="../../../imagenes/modificar.gif" onClick="Start('modificaArista.php?<?=$phpsession ?>&aristaAModificar=<?=$codigoArista?>&proceso=<?=$procesoSelected?>',700,600);">
 ...
 <td width="10%" class='listado2' ><font size=1>
 	<center><?php echo $terminos ?></center>
 </td>
  <?php
    if ($crear == 0) {
    ?> 
