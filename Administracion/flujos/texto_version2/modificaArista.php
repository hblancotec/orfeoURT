...
//	include "$ruta_raiz/debugger.php";
	...
	if( $_GET['aristaAModificar'] != '' ){
		...
		$rs = $db->conn->Execute( $queryModifica );
...
<table border=1 width=93% class=t_bordeGris align="center">
	   <tr>
        ...
        <tr>
            ...
            <td height="23" colspan="4" class="listado2" width="25%">
             	   <input type="checkbox" name="automatico" value="$automatic" <?php if ($automatico) echo "checked"; else echo "";?> >
            </td>
        </tr>
        <tr>
        	<td height="23" colspan="4" class="titulos2" width="25%">
            ...
            <td height="23" colspan="4" class="listado2" width="25%">
                <input type="checkbox" name="tipificacion" value="$tipificacion" <?php if ($tipificacion) echo "checked"; else echo "";?> onchange="submit();">
            </td>
            <td height="23" colspan="4" class="titulos2" width="25%">
