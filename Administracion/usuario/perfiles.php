...
?>
<script>
		alert("El número de cédula escrito tiene la siguiente información.");
...
function envio_datos()
{
	...
	{
		alert("No se ha diligenciado el Número de la Cedula del Usuario, o a diligenciado un valor no númerico. Por favor digítelo.");
	...
	{
		alert("No se ha diligenciado el Login del Usuario por favor digítelo.");
	...
	{
		alert("No se ha diligenciado el Nombre por favor digítelo.");
...
<table width="50%" border="1" cellspacing="0" cellpadding="4" bordercolor="#CCCCCC" align="left">
  <tr>
    <td colspan="2" aling="center"><div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><strong>Administración de Usuarios y Perfiles</strong></font></div></td>
  </tr>
  <?php
if ($editar)
	{
...
?>
  <tr>
    <td colspan="2"><div align="center"><strong>Creación de Usuarios</strong> </div></td>
  </tr>
  <?php
	}
?>
...
?>
    ...
    <tr>
      <td width="50%" class="vbmenu_control" align="left"> <span class="Estilo5"><font size="2">Ubicación</font> </span></td>
    ...
    <tr>
      <td width="50%" class="vbmenu_control" align="left"> <span class="Estilo5"><font size="2">Extensión</font> </span></td>
    ...
    <tr>
      ...
      <td width="80%"><input name="email" type="text" size="73" maxlength="73" value='<?=$rs->fields["USUA_EMAIL"]?>'>
       ...
       <td width="80%"><input name="email" type="text" size="73" maxlength="73" value='<?=$rs->fields["USUA_EMAIL_1"]?>'>
       <td width="50%" class="vbmenu_control" align="left"> <span class="Estilo5"><font size="2">E-Mail 3</font> </span></td>
       <td width="80%"><input name="email" type="text" size="73" maxlength="73" value='<?=$rs->fields["USUA_EMAIL_2"]?>'>
      </td>
    </tr>
    <tr>
