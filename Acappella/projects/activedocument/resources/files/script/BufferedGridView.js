    ...
    onBeforeLoad : function(store, options)
    {
        if (!options.params) {
            ...
            options.params.limit = this.ds.bufferSize;
				...
				//jcr
				options.params.columns  = this.ds.columns; //nombre de las columnas
				options.params._source  = this.ds._source;	 // fuente de datos
				options.params._usuario = _usuario_info.id  // id del usuario
