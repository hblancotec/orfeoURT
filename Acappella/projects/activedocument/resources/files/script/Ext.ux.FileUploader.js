 ...
 * @version $Id: Ext.ux.FileUploader.js,v 1.1 2008/10/31 22:59:08 jrodriguez Exp $
 * @date    15. March 2008
 *
...
Ext.extend(Ext.ux.FileUploader, Ext.util.Observable, {
	 ...
	 */
	 // jcr se adicionan parametros config
	...
	,uploadFile:function(record, params) {
		...
		//jcr
		for (c in this.config.params) {
		   o.params[c] = this.config.params[c];
		};
		o.success = this.config.success;
		o.failure = this.config.failure;
		//jc 
		// request upload
		Ext.Ajax.request(o);
