...
if ($enviar_new){
  		$isql_hl= "select PLG_CODI
                        from PL_GENERADO_PLG
                        order by PLG_CODI desc";
...
// FIN GRABACION O CREACION DE NUEVO DOC 
 ...
 if (!$nombre_pl)  {
    $archivo = "pl_txt/plantilla_nueva.txt"; $nombre_pl = "Descripcion Plantilla";
}
if(!$enviar and !$enviar_new) {
    ...
    <tr> 
     ...
     ?>
      <td  align="center"  valign="top" border=1>
        <input type="submit" name="enviar" value='Grabar' class='e_buttons'>
