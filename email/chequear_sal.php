...
formulario.submit();
        ...
        <TD height="25" width="25%" class="celdaGris" > 
          <input name="noradicado" type="text" class="ecajasfecha" id="sapl" size="16" value="<?php echo $noradicado;?>">
        </TD>
      </TR>
      ...
      <tr> 
        ...
        <td width="25%" height="25" class="celdaGris" > 
          <input name="papl" type="text" class="ecajasfecha" id="papl6" size="20" value="<?php echo $papl;?>">
        </td>
        <td width="25%" height="25" align="right" class="grisCCCCCC" ><font face="Arial, Helvetica, sans-serif" class="etextomenu"> 
          SEGUNDO APELLIDO</font></td>
        <td width="25%" height="25" class="celdaGris" > 
          <input name="sapl" type="text" class="ecajasfecha" id="sapl6" size="20" value="<?php echo $sapl;?>">
        </td>
      </tr>
      <tr> 
        <td width="25%" height="25" align="right" class="grisCCCCCC" ><font face="Arial, Helvetica, sans-serif" class="etextomenu"> 
    ...
    ?> 
        ...
        <td width="25%" height="25" class="celdaGris" ><strong> 
          <input name="numdoc" type="text" class="ecajasfecha" id="numdoc6" size="20" value="<?php echo $numdoc;?>">
      ...
      <tr> 
        ...
        <td colspan="3" class="celdaGris" > 
          <input name="papl2" type="text" class="ecajasfecha" id="papl" size="30" value="<?php echo $remitente;?>">
        </td>
      </tr>
      <tr align="center"> 
  ...
  $iusuario = " ";
	...
	if($carpeta==11  and $codusuario ==1)
	{
	 ...
	 } else 
	 {
          ...
          <td height="3"> 
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
                ...
                <td width="89%"> <a href='cuerpopdf.php?<?=SID ?>&<?php echo "fechah=$fechah&orno=7"; ?>' alt='Ordenar Por Leidos'><span class='tpar'>Impresos</span></a> 
                  <?=$img7 ?>
                  <a href='cuerpopdf.php?<?=SID ?>&<?php echo "fechah=$fechah&orno=8"; ?>' alt='Ordenar Por Leidos' class="tparr"><span class='tparr'> 
      ...
      <form name='form1' action='imprimir_pdf.php?<?=session_name()."=".session_id() ?>' method=post target='pdf_<?php echo date("dmy_h_m_s");  ?>'>
			...
			<td class='<?=$leido ?>'><font size=1><?=$urlimagen ?>
              <?
				...
				while($result3=ora_fetch_into($cursor3,$row3, ORA_FETCHINTO_NULLS|ORA_FETCHINTO_ASSOC))
				{
				   ...
				   $observaciones .= $row3["HIST_FECH"]."</td><td width=85%>".preg_replace("(\r\n|\n|\r)", " ", $HIST_OBSE)."</td></tr>";
