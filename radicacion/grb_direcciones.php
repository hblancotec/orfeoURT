...
//$conexion->conn->debug = true;
    ...
    if($documento_us1  and substr($cc,0,1)!="G") {
        ...
        if (!is_null($muni_tmp1))	$record['MUNI_CODI'] = $muni_tmp1;
        if (!is_null($dpto_tmp1))	$record['DPTO_CODI'] = $dpto_tmp1;
        if (!is_null($idpais1))		$record['ID_PAIS']   = $idpais1;
        if (!is_null($idcont1))		$record['ID_CONT']   = $idcont1;
          ...
          $newId=true;
            ...
            $isql = "update SGD_DIR_DRECCIONES
                            set MUNI_CODI=$muni_tmp2,
                                ...
                                SGD_DIR_CODPOSTAL='$codpostal_us2',
