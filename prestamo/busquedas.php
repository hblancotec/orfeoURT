...
?>
     <table class="FormTABLE">
      ...
      <tr>
       ...
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormPRESTADOS_Sorting=6&FormPRESTADOS_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Fecha de Préstamo</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormPRESTADOS_Sorting=7&FormPRESTADOS_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Descripción</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormPRESTADOS_Sorting=8&FormPRESTADOS_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Fecha de Devolución</font></a></td>
...
//-----------------------
  ...
  $ps_hasta_RADI_FECH_RADI = Date('d-m-Y H:i:s',mktime(23,59,59,get_param("s_hasta_mes"),get_param("s_hasta_dia") + 1,get_param("s_hasta_ano")));
...
//-------------------------------
  $sSQL = "select P.DEPE_CODI as P_DEPE_CODI, " . 
    ...
    "P.RADI_NUME_RADI as P_RADI_NUME_RADI, " . 
...
?>
      ...
      <?= tohtml($fldPRES_FECH_PEDI) ?>&nbsp;</font></td>
       <td class="DataTD"><font class="DataFONT">
      <?php $fldPRES_REQUERIMIENTO = get_lov_value($fldPRES_REQUERIMIENTO, $aPRES_REQUERIMIENTO); ?>
      ...
      <?= tohtml($fldUSUA_LOGIN_PRES) ?>&nbsp;</font></td>
       <td class="DataTD"><font class="DataFONT">
      <?php $fldPRES_ESTADO = get_lov_value($fldPRES_ESTADO, $aPRES_ESTADO); ?>
