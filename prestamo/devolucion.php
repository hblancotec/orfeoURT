...
?>
     <table class="FormTABLE">
      ...
      <tr>
       ...
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormPRESTAMO_Sorting=2&FormPRESTAMO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Solicitó</font></a></td>
       ...
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormPRESTAMO_Sorting=4&FormPRESTAMO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Prestó</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormPRESTAMO_Sorting=5&FormPRESTAMO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Descripción</font></a></td>
