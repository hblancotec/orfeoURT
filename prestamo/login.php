...
//-------------------------------
      ...
      $sPassword = substr(md5($sPassword),1,26);
       ...
       $rs = $db->conn->Execute("SELECT USUA_LOGIN, DEPE_CODI FROM USUARIO WHERE USUA_LOGIN =" . tosql($sLogin, "Text") . " AND USUA_PASW=" . tosql($sPassword, "Text") . " AND USUA_ADMIN=1");
...
//-------------------------------
    ...
    $rs=$db->conn->Execute("SELECT USUA_LOGIN FROM USUARIO WHERE USUA_LOGIN=". tosql($usuario,"Text"));
