...
?>					 
                     <tr class='tpar'> 
                        <td <?php echo $tipoListado; ?>><?=$fldDEPENDENCIA?></td>
                        <td <?php echo $tipoListado; ?>><?=$fldFECHA?></td>
                        <td <?php echo $tipoListado; ?>>Doc F&iacute;sico - <?=$fldTRANSACCION?></td>
                        <td <?php echo $tipoListado; ?>><?=$fldUSUARIO?></td>
                        <td <?php echo $tipoListado; ?>><?=$fldCOMENTARIO?></td>
                     </tr>
<?php
      $rs->MoveNext();
      $iCounter++;
