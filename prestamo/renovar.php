...
//-------------------------------
  if($sAction == "insert" || $sAction == "update") 
  {
    if(!strlen($fldPRES_FECH_VENC))
      $sPRESTAMOErr .= "El valor en el campo Fecha de Préstamo se requiere.<br>";
    
/*    if(!strlen($fldcontrasena))
      $sPRESTAMOErr .= "El valor en el campo Contraseña de Usuario se requiere para renovar.<br>";
*/    
//-------------------------------
...
if($fldPRES_ESTADO ==2){
  ...
  $rs=$db->conn->Execute("SELECT USUA_LOGIN FROM USUARIO WHERE USUA_LOGIN =" . tosql($fldusuario, "Text") . " AND USUA_PASW=" . tosql($fldcontrasena, "Text"));
...
//-------------------------------
    ?>
      ...
      <tr>
       ...
       <td class="DataTD">
         <font class="DataFONT"><input type="hidden" name="USUA_LOGIN_PRES" maxlength="30" value="<?= tohtml($fldUSUA_LOGIN_PRES) ?>" size="15" ><?=$fldUSUA_LOGIN_PRES?></font>
       </td>
     </tr>
      <tr>
       <td class="FieldCaptionTD">
      ...
      <tr>
       ...
       <td class="DataTD">
         <font class="DataFONT"><input type="hidden" name="PRES_DESC" maxlength="50" value="<?= tohtml($fldPRES_DESC) ?>" size="20" ><?=tohtml($fldPRES_DESC)?></font>
       </td>
     </tr>
      <tr>
       <td class="FieldCaptionTD">
