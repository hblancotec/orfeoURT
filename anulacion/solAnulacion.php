 ...
 *  @$filtroSelect Si SetfiltoSelect contiene algunvalor la siguiente rutina realiza el arreglo de la condiciÃ³n para la consulta a la base de datos y lo almacena en whereFiltro.
...
if($checkValue)
{
	...
	while ($i < $num)
	{
	   $record_id = key($checkValue);
		...
		//Validacion de anulacion respecto de aplicativos externos
...
function Anular(tipoAnulacion)
{
	...
	if(marcados>=1)
	{
		confirmar = confirm("Se asignará(n) o modificará(n) la(s) TRD con la tipología ANULADO y se ARCHIVARÁ(N) automáticamente");
		if (confirmar){
...
<table border=0 width=100% cellpadding="0" cellspacing="0">
	...
	$pager->Render(20, $linkPagina, 'chkAnulados');
	?>
