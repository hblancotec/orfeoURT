...
<?php
	...
	$flag==0;
  	if ($flag==1) 
	echo "No se grabo ....";
	$isql = "SELECT a.SGD_HMTD_CODIGO
            FROM  SGD_HMTD_HISMATDOC a
						where rownum < 10 
...
<?php
    if($tpdoc) {
	$isql = "select distinct a.*
                from SGD_FUN_FUNCIONES a,
                        sgd_mat_matriz b,
                        SGD_MTD_MATRIZ_DOC c
                where b.sgd_mat_codigo = c.sgd_mat_codigo and
                        c.sgd_tpr_codigo = $tpdoc and
                        a.sgd_fun_codigo = b.sgd_fun_codigo and
...
?>
  ...
  <tr>
	...
	<?php
	  $isql = "select distinct a.*
                from sgd_prc_proceso a,
                        sgd_mat_matriz b 
	            where a.sgd_prc_codigo = b.sgd_prc_codigo and
...
<?php
	...
	echo "Codigo Combinaci&oacute;n $cod_tmp_new";
?>
...
<table border=0 id=mod_resolucion cellpadding="0" cellspacing="5" class="borde_tab">
  <tr> 
    <td align="center" class='titulos2'> 
      <p>MODIFICAR DATOS DE LA RESOLUCION </p>
    </td>
  </tr>
  <tr> 
    <td> 
