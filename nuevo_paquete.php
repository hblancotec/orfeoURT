...
$q="select b.SGD_PNUFE_CODI,
            ...
            a.SGD_DNUFE_MAIN,
            a.TRTE_CODI
        from sgd_dnufe_docnufe a,
                sgd_pnufe_procnumfe b,
                sgd_tpr_tpdcumento c
        where b.sgd_pnufe_codi = a.sgd_pnufe_codi and
                c.sgd_tpr_codigo = a.sgd_tpr_codigo and
                b.sgd_pnufe_codi = $tipoPaquete
        order by a.sgd_dnufe_main desc";
...
<table width="75%"  style="border-collapse: collapse; border: groove;"  >
  <tr> 
	...
	<?php
	// Si es el documento principal pinta el último número generado y los argumentos
...
?>
          <input type="hidden" <?php echo "NAME=completitudDestinatario[$destinatario]"?>  value="<?php $remitenteDocumento->verificarCompletitud($destinatario); ?>">
					<input type="hidden" <?php echo "NAME=existeDocumento[$codDocumento]"?>  
