 ...
 * @date      4. April 2008
 * @version   $Id: Ext.ux.grid.RecordForm.js,v 1.1 2008/10/14 15:56:59 csepulveda Exp $
 *
...
Ext.extend(Ext.ux.grid.RecordForm, Ext.util.Observable, {
	...
	,defaultWindowConfig:{
		...
		,closeAction:'hide'
		,modal:true
		,plugins:[new Ext.ux.IconMenu({defaultItems:[]})]
	}
	...
	/**
	 * @cfg {Number} focusDefer Time in ms before the firs form field is focused
	 * @private
	 */
	,focusDefer:200
	...
	// {{{
	/**
	 * Override this to add a processing you need to run after the record update
	 ...
	 * @param {Ext.data.Record} record record we shoul return the class for
	 */
